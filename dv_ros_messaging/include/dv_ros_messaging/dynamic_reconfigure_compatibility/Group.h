...
namespace dynamic_reconfigure
{
	template <class ContainerAllocator>
		struct Group_
			...
			typedef std::vector< ::dynamic_reconfigure::ParamDescription_<ContainerAllocator>, boost::container::allocator<::dynamic_reconfigure::ParamDescription_<ContainerAllocator>>  >  _parameters_type;
...
namespace ros
{
	namespace serialization
	{
		...
		template<> struct Serializer< ::dynamic_reconfigure::Group_<boost::container::allocator<void>> >
			{
